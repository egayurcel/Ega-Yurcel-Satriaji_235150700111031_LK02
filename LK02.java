...
class driver {
    public boolean noSimBus;
    public boolean noSimTruk;
    public String noSim;
...
public class LK02 {
    public static void main(String[] args) {
        int pilihan = 0;
        driver supir = new driver(true, false, "12345678");
        Bus bus = new Bus("Mercedes", "AG 1 OKE", 10, true, supir);
        Truk truk = new Truk("Hino", "AG 2 ABC", 5, 2.0, supir);
